...
%>
    ...
    <div class="container1">
     <div class="item-pic"><img src="<%=orderItems.getImagePath() %> " alt="pic"></div>
    ...
    <a href="callcart?itemId=<%=orderItems.getMenuId() %>&itemName=<%=orderItems.getItemName() %>&price=<%=orderItems.getPrice() %>&restaurantid=<%=orderItems.getRestaurantId() %>">
