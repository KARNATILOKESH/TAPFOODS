...
<nav>
  ...
  <div class="options">
          <div class="all"> <a href="onlyveg?restaurantId=<%=restaurant.getRestaurantId() %>">Only Veg</a></div>
          <div class="all"> <a href="onlynonveg?restaurantId=<%=restaurant.getRestaurantId() %>">Only NonVeg</a></div>
          <div class="all"> <a href="callindexmenu?restaurantId=<%=restaurant.getRestaurantId() %>"> All Items</a></div>
            <div class="top-rated"><a href="toprated?restaurantId=<%=restaurant.getRestaurantId() %>">Top Rated</a></div>
            <div class="price-low-to-high"><a href="pricelowtohigh?restaurantId=<%=restaurant.getRestaurantId() %>">Price Low To High</a></div>
            <div class="price-high-to-low"><a href="pricehightolow?restaurantId=<%=restaurant.getRestaurantId() %>">Price High To Low</a></div>
        </div>
		...
		<div class="menu">
			<div class="item">
				...
				<img alt="picture" src="<%=menu.getImagePath() %>">
					<a href="callindexcart?itemId=<%=menu.getMenuId() %>&restaurantid=<%=restaurant.getRestaurantId() %>">
					<div class="add">
						<b> ADD </b>
					</div>
					</a>
