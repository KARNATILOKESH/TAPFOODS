...
<nav>
	...
	<div class="profile-details" id="profile-details">
		...
		<div class="logout-edit">
			<div class="log"><a href="indexservlet">LogOut</a></div> <div class="edit"><a href="calledit?isthisviewcart=viewcart">Edit</a></div>
		</div>
 ...
 <div class="container">
    ...
    <div class="container1">
     ...
     <div class="quantity">
       <a href="less?itemId=<%=cart.getItemId()%>&itemName= <%=cart.getItemName()%>&quantity=<%=cart.getQuantity()%>&price=<%=cart.getPrice()%>&restaurantId=<%=cart.getRestaurantId()%>"><div class="less"><span ><b>-</b></span></div></a>
       <div class="quan"><%=cart.getQuantity()%></div>
       <a href="add?itemId=<%=cart.getItemId()%>&itemName= <%=cart.getItemName()%>&quantity=<%=cart.getQuantity()%>&price=<%=cart.getPrice()%>&restaurantId=<%=cart.getRestaurantId()%>"><div class="add"><span><b>+</b></span></div></a>
     </div>
     <div class="delete"><a href="remove?itemId=<%=cart.getItemId()%>"><img src="http://localhost:8080/tapfoods/Images/delete-icon.png" alt="delete"></a></div>
    </div>
    ...
    <div class="container2">
         <a href="callmenu?restaurantId=<%=rid%>&quantity=<%=quantity%> %>"><div class="addmore">ADD MORE ITEMS</div></a>
         <a href="CheckOut.jsp"><div class="chechout">PROCEED TO CHDECKOUT</div></a>
    </div>
