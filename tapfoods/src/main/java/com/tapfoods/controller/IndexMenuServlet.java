...
@WebServlet("/callindexmenu")
public class IndexMenuServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// getting menu items from menu table using restaurantId
		List<Menu> allMenus = menuDaoImpl.getByRestaurantId(restuarantId);
		
		//storing that all menus into request object
